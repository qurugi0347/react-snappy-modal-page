      ...
      <FeaturesGrid>
        <Feature
          icon={
            ...
            >
              <path
                d="M9 16.1716L19.071 6.1005L20.4852 7.51472L9 18.9999L3.51472 13.5146L4.92893 12.1004L9 16.1716Z"
                fill="#111827"
              />
            </svg>
          }
        ...
        <Feature
          icon={
            ...
            >
              <path
                d="M21 10.12H14.22L16.96 7.3C14.23 4.6 9.81 4.5 7.08 7.2C4.35 9.91 4.35 14.28 7.08 17C9.81 19.7 14.23 19.7 16.96 17C18.32 15.65 19 14.08 19 12.1H21C21 14.08 20.12 16.65 18.36 18.39C14.85 21.87 9.15 21.87 5.64 18.39C2.14 14.92 2.11 9.28 5.62 5.81C9.13 2.34 14.76 2.34 18.27 5.81L21 3V10.12ZM12.5 8V12.25L16 14.33L15.28 15.54L11 13V8H12.5Z"
                fill="#111827"
              />
            </svg>
          }
        ...
        <Feature
          icon={
            ...
            >
              <path
                d="M7 21C5.9 21 5 20.1 5 19V5C5 3.9 5.9 3 7 3H17C18.1 3 19 3.9 19 5V19C19 20.1 18.1 21 17 21H7ZM7 5V19H17V5H7Z"
                fill="#111827"
              />
              <path
                d="M11 8H13V16H11V8ZM15 12H17V16H15V12ZM7 12H9V16H7V12Z"
                fill="#111827"
              />
            </svg>
          }
